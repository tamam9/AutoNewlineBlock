 ...
 * {@link BlankFrag.OnFragmentInteractionListener} interface
...
public class BlankFrag extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        LogUtils.i("frag start");
    }

    @Override
    public void onResume() {
        super.onResume();
        LogUtils.i("frag resume");
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        LogUtils.i("frag viewcreated");
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        LogUtils.i("frag activitycreated");
    }

    @Override
    public void onSaveInstanceState(Bundle outState) {
        super.onSaveInstanceState(outState);
        LogUtils.i("frag saveInstance ");
    }
}
